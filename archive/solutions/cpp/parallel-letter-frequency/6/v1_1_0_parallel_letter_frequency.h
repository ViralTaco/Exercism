...
#ifndef vt_parallel_letter_frequency_v1_1_0
#define vt_parallel_letter_frequency_v1_1_0 "com.viraltaco.letter-frequency v" "1.1.0"
...
namespace parallel_letter_frequency::v1_1_0 {
struct frequency {
 public:
 ...
 private:
  class frequency_map {
   ...
   public:
    ...
    auto combine(frequency_map const& other) noexcept -> void {
      if (not other.zero) {
        self += other.self;
        zero = false;
      }
